Feature: ID05_Add Team Members to the Company Group
    ...
    Scenario: (Normal Flow) Adding an existing Team Member to the Company Group with their name
    ...
    Scenario: (Alternative Flow) Adding an existing Team Member to the Company Group with their email
        When the stakeholder clicks on “Invite Members” button
        And the stakeholder enters email <email> of the Team Member
        Then the Team Member is invited to the Company Group

    Scenario: (Error Flow) Adding a non-existing Team Member to the Company Group
    Scenario Outline: Adding a non-existing Team Member to the Company Group (Error Flow)
        When the stakeholder clicks on “Invite Members” button
