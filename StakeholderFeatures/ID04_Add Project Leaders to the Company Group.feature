Feature: ID04_Add Project Leaders to the Company Group
    ...
    Scenario: (Normal Flow) Adding an existing Project Leader to the Company Group with their name
    ...
    Scenario: (Alternative Flow) Adding an existing Project Leader to the Company Group with their email
        When the stakeholder clicks on “Invite Leaders” button
        And the stakeholder enters email <email> of the Project Leader
        Then the Project Leader is invited to the Company Groupd

    Scenario: (Error Flow) Adding a non-existing Project Leader to the Company Group
        When the stakeholder clicks on “Invite Leaders” button
